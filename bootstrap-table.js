...
(function ($) {
	...
	//开放对外接口，方便插件扩展
    $.fn.bootstrapTable.Constructor = BootstrapTable;//构造器
    $.fn.bootstrapTable.defaults = BootstrapTable.DEFAULTS;//默认的参数对象格式
    $.fn.bootstrapTable.columnDefaults = BootstrapTable.COLUMN_DEFAULTS;
    $.fn.bootstrapTable.locales = BootstrapTable.LOCALES;//默认多语言？
    $.fn.bootstrapTable.methods = allowedMethods;//默认方法
    ...
    // =======================
	//初始化函数，在含有[data-toggle="table"]的元素上绑定bootstrapTable方法
    $(function () {
